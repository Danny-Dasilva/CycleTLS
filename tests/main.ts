...
var myDictionary = {
  ...
  // },
  'https://httpbin.org/ip' : {}, //log ip 
  'https://httpbin.org/response-headers?ExampleResponseHeader=HeaderisPickedUpByServer' : {}, //log response headers
  'https://httpbin.org/html' : {}, //log html
  'https://httpbin.org/delay/3' : {} //this request will wait 3 s before returning so it should always show up last in the log
