...
func clientBuilder(browser browser, dialer proxy.ContextDialer, timeout float32, disableRedirect bool) http.Client {
...
func newClient(browser browser, timeout float32, disableRedirect bool, proxyURL ...string) (http.Client, error) {
	//fix check PR
